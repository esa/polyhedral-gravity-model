...
PYBIND11_MODULE(polyhedral_gravity, m) {
    ...
    utility.def("check_mesh",
                ...
                is greater zero.
                Further, Checks if all the polyhedrons plane unit normals are pointing outwards.
                ...
                Args:
                    ...
                    faces (2-D array-like): (N, 3) array of faces, vertex-indices (ints).
                Returns:
                    True if no triangle is degenerated and the polyhedrons plane unit normals are all pointing outwards.
          )mydelimiter",
