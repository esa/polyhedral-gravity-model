...
namespace polyhedralGravity::GravityModel {
    ...
    GravityModelResult
    evaluate(const Polyhedron &polyhedron, double density, const Array3 &computationPoint, bool parallel) {
        GravityEvaluable evaluable{polyhedron, density};
        return evaluable(computationPoint, parallel);
    }

    std::vector<GravityModelResult>
    evaluate(const Polyhedron &polyhedron, double density, const std::vector<Array3> &computationPoints, bool parallel) {
        GravityEvaluable evaluable{polyhedron, density};
