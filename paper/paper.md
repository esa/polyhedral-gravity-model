...
While some research code for these models exists TODO LINKS, they are focused on usability and limited to FORTRAN [@TODOLINK] and proprietary software like MATLAB [@TODOLINK]. There is a lack of well-documented, maintained open-source implementations, particularly in modern programming languages and with a focus on scalability and performance.
